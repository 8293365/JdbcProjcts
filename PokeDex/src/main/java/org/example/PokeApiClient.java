...
public class PokeApiClient {
    private static final String API_URL = "https://pokeapi.co/api/v2/pokemon/"; // URL to fetch Pikachu data
    //final is a modifier
    private Gson gson;
    ...
    public PokemonData fetchPikachuData() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(API_URL + "pikachu"))
                .build();
        ...
        try {
            ...
            if (client.isTerminated()) {
                throw new IOException("Unexpected code " + client.toString());
            }
    ...
    public PokemonData RubenfetchPikachuData(){
        HttpRequest request = HttpRequest.newBuilder()
